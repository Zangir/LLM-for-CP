...
class VRP():
    def __init__(self, max_interval, num_cities, num_vehicles):
        self.max_interval = max_interval
    ...
    def get_variables(self):
        ...
        self.variables = (coords, dist_mat)
    ...
    def create_prompt(self):
        coords = self.variables[0]
        inp_vrp1 = """You are given a list of points with coordinates: """
        inp_vrp2 = ""
        ...
        inp_vrp3 = """ Find the route that has a minimum total length and go though all the points, starting and ending in the first point. Return only the final route as a set of indices. """
        inp_vrp = inp_vrp1 + inp_vrp2 + inp_vrp3
